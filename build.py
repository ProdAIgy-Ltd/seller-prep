...
<div class="fld full"><label for="g-photo">Headshot address, if you have one online</label>
<input type="text" id="g-photo" placeholder="https://...jpg">
<div class="hint">Leave this empty and the close simply has no photograph.</div></div>
</form>
</div>
...
def main():
    ...
    print("  copy gate passed on every rendered page")
